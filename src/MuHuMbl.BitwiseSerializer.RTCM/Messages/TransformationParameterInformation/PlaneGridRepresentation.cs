...
{
    public class PlaneGridRepresentation : IRtcmMessage
    {
        ...
        [RtcmField(4, RtcmType.Int25)]
        public int NorthingOfOrigin { get; set; }
        
        [RtcmField(5, RtcmType.Uint26)]
        public uint EastingOfOrigin { get; set; }
        ...
        [RtcmField(8, RtcmType.Int10)]
        public short MeanLocalNorthingOffset { get; set; }
        
        [RtcmField(9, RtcmType.Int10)]
        public short MeanLongitudeOffset { get; set; }
